...
try {
    $response = Invoke-RestMethod -Uri "http://localhost:5023/api/user" -Method Post -Body $userData -ContentType "application/json"
...
try {
    $loginResponse = Invoke-RestMethod -Uri "http://localhost:5023/api/login" -Method Post -Body $loginData -ContentType "application/json"
    ...
    try {
        ...
        $usersResponse = Invoke-RestMethod -Uri "http://localhost:5023/api/user" -Method Get -Headers $headers
    ...
    try {
        ...
        $logoutResponse = Invoke-RestMethod -Uri "http://localhost:5023/api/login/logout" -Method Post -Headers $headers
